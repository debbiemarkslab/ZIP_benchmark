...
if __name__ == "__main__":
    ...
    for uniparc_id in tqdm(df[uniq_col].unique()):
        ...
        subset["label"] = "Benign"
        subset = subset.drop("HGVSp", axis=1)
        subset = subset.rename(columns={"protein_variant":"HGVSp"})
    ...
    create_mapfile(args.output_folder, args.mapping_file, args.alignment_folder)
