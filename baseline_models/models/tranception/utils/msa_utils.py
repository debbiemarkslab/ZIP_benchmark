...
def get_msa_prior(MSA_data_file, MSA_weight_file_name, MSA_start, MSA_end, len_target_seq, vocab, retrieval_aggregation_mode="aggregate_substitution", filter_MSA=True, verbose=False, filter_threshold=0.2):
    """
    ...
    if filter_MSA:
        ...
        for sequence_name in list_sequence_names:
            ...
            if hamming_similarity_seq_ref < filter_threshold:
...
def update_retrieved_MSA_log_prior_indel(model, MSA_log_prior, MSA_start, MSA_end, mutated_sequence, clustal_suffix=""):
    """
    ...
    sampled_MSA_location = model.MSA_folder + os.sep + "Sampled" + os.sep + clustal_suffix + "_" + "Sampled_" + model.MSA_filename.split(os.sep)[-1]
    ...
    seq_to_align_location = model.MSA_folder + os.sep + "Sampled" + os.sep + clustal_suffix + "_" + "Seq_to_align_" + model.MSA_filename.split(os.sep)[-1]
    ...
    expanded_MSA_location = model.MSA_folder + os.sep + "Sampled" + os.sep + clustal_suffix + "_" + "Expanded_" + model.MSA_filename.split(os.sep)[-1] 
