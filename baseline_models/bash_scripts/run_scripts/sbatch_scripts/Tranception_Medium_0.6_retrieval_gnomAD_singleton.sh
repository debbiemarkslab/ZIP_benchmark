...
#SBATCH --job-name="tranception_medium_gnomad_singleton_60R"
...
# #SBATCH --array=0-1541:250
#SBATCH --array=250-251:250
# #SBATCH --array=0-1:5
###############################################################################
...
PROTEIN_FOLDER="${REPO_ROOT}/processed_data/gnomAD/by_uniparc_singletons"
MAP_FILE="${REPO_ROOT}/processed_data/gnomAD/mapfiles/gnomad_filtered_singleton_indels_dedup_lt3aa_random10_mapfile.csv"
MSA_FOLDER="${REPO_ROOT}/alignments/focus_column_only/gnomAD"
NAME="gnomAD_singleton_Tranception_Medium_0.6_retrieval"
OUTPUT_FOLDER="${REPO_ROOT}/outputs/output_scores/${NAME}"
MODEL_CHECKPOINT="${REPO_ROOT}/baseline_models/model_checkpoints/Tranception_Medium"
TOKENIZER_PATH="${REPO_ROOT}/baseline_models/model_checkpoints/tokenizers/Tranception/Basic_tokenizer"
BATCH_SIZE=1
CLUSTAL_LOCATION="${REPO_ROOT}/clustal/clustalo-1.2.4-Ubuntu"

/n/groups/marks/software/anaconda_o2/envs/indels_env/bin/python ${REPO_ROOT}/baseline_models/scoring/score_tranception.py \
...
--tokenizer_filepath=$TOKENIZER_PATH --num_workers=4 --clustal_suffix="_medium"