...
#SBATCH --job-name="tranception_large_gnomad_singleton_60R"
...
NAME="gnomAD_singleton_Tranception_Large_0.6_retrieval"
OUTPUT_FOLDER="${REPO_ROOT}/outputs/output_scores/${NAME}"
MODEL_CHECKPOINT="${REPO_ROOT}/baseline_models/model_checkpoints/Tranception_Large"
