...
#SBATCH --job-name="tranception_large_scoring_DMS_60R"
...
NAME="DMS_Tranception_Large_0.6_retrieval"
...
--tokenizer_filepath=$TOKENIZER_PATH --num_workers=4 --label_column="DMS_score"
