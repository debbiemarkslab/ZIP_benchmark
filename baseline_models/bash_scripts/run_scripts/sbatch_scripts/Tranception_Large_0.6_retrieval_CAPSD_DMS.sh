...
#SBATCH --job-name="tranception_large_scoring_DMS_CAPSD_60R"
...
PROTEIN_FOLDER="${REPO_ROOT}/processed_data/DMS_chunked/CAPSD_AAV2S_Sinai_indels_2021"
MAP_FILE="${REPO_ROOT}/processed_data/DMS_chunked/CAPSD_AAV2S_Sinai_indels_2021/mapfile_CAPSD_AAV2S_Sinai_indels_2021_chunked.csv"
MSA_FOLDER="${REPO_ROOT}/alignments/focus_column_only/DMS"
NAME="DMS_Tranception_Large_0.6_retrieval_CAPSD"
...
--tokenizer_filepath=$TOKENIZER_PATH --num_workers=4 --label_column="DMS_score" --clustal_suffix=$SLURM_ARRAY_TASK_ID
